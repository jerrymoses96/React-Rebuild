          ...
          <div className="flex flex-row justify-end w-full py-3.5 mx-auto md:px-5 max-w-[10689px]">
            <div className="flex flex-col items-center justify-start w-full mt-[9px] gap-2">
              ...
              {/* top categories  */}
                  ...
                  <div className="flex flex-row md:flex-col w-full  gap-3.5 px-[13px] border-gray-200 border border-solid rounded-lg">
                      ...
                      <div className="flex flex-row justify-start items-start w-full gap-[15px]">
                        <div className="flex flex-col items-center justify-start w-[89%] mt-[15px] gap-1">
                          <Img
                            ...
                            alt="fruits"
                            className="w-[122px] md:h-auto object-cover"
                          />
                          <a href="#">
                            <Text
                              as="p"
                              className="!text-black-900 tracking-[-0.26px] text-center !font-medium"
                            >
                              Fruits & Vegetables
                            </Text>
                          </a>
                        </div>
                        <div className="h-[179px] w-px bg-gray-200" />
                      </div>
                    </div>
                    <Img
                      src="images/img_link_baby_care_png.png"
                      alt="linkbabycare"
                      className="w-[10%] md:h-auto mt-[15px] mb-[42px] md:mt-0 object-cover"
                    />
                    <a href="#" className="mt-[141px] mb-[21px] md:mt-0">
                      <Text
                        as="p"
                        className="!text-black-900 tracking-[-0.26px] text-center !font-medium"
                      >
                    ...
                    <div className="flex flex-col items-center justify-start w-[12%] md:w-full">
                      <div className="flex flex-row justify-start items-center w-full gap-3.5">
                        <div className="h-[179px] w-px bg-gray-200" />
                        <div className="flex flex-col items-center justify-start w-[80%] gap-1">
                          <Img
                    ...
                    <Img
                      ...
                      alt="linkmeatfish"
                      className="w-[10%] md:w-full md:h-[121px] mt-[15px] mb-[42px] md:mt-0 object-cover"
                    />
                    <a href="#" className="mt-[139px] mb-[23px] md:mt-0">
                      <Text
                        as="p"
                        className="!text-black-900 tracking-[-0.26px] text-center !font-medium"
                      >
                    ...
                    <div className="h-[179px] w-px md:w-full md:h-px mb-px bg-gray-200" />
                    <Img
                    ...
                    <Img
                      ...
                      className="w-[10%] md:w-full md:h-[121px] mt-[15px] mb-[42px] md:mt-0 object-cover"
                    />
                    <a href="#" className="mt-[141px] mb-[22px] md:mt-0">
                      <Text
                        as="p"
                        className="!text-black-900 tracking-[-0.26px] text-center !font-medium"
                      >
                    ...
                    <div className="flex flex-col items-center justify-start w-[12%] md:w-full">
                      <div className="flex flex-row justify-start items-center w-full gap-3.5">
                        <div className="h-[179px] w-px bg-gray-200" />
                        <div className="flex flex-col items-center justify-start w-[80%] gap-[3px]">
                          <Img
                ...
                <div className="h-[85px] w-full mt-7 px-[31px] sm:px-5 border-orange-50 border border-solid bg-yellow-50 relative rounded-md">
                  <div className="flex flex-row md:flex-col justify-center w-max h-full left-0 bottom-0 right-0 top-0 m-auto md:gap-5 absolute">
                    <div className="flex flex-row md:flex-col justify-center items-start w-[61%] md:w-full md:gap-5">
                      <Heading
                        as="h4"
                        className="mt-[22px] md:mt-0 !text-orange-900 tracking-[-0.44px]"
                      >
                      ...
                      <Heading
                        size="9xl"
                        as="h5"
                        className="ml-[-44px] md:ml-0 !text-transparent tracking-[-8.00px] bg-gradient3 bg-clip-text"
                      >
                        %50
                      </Heading>
                    </div>
                    <Img
                      src="images/img_promo_png.png"
                      alt="promopng_one"
                      className="w-[45%] md:w-full md:h-[85px] ml-[-62px] md:ml-0 object-cover"
                    />
                  </div>
                  <Text
                    size="xl"
                    as="p"
                    className="bottom-[24%] left-[2%] m-auto tracking-[-0.32px] !font-normal absolute"
                  >
                    The only supermarket that makes your life easier, makes you
                    enjoy life and makes it better
                  </Text>
                </div>
